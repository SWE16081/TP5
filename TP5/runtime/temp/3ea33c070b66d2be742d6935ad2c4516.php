	...
	<div class="con">热门标签：
        ...
        <div class="overall">
            <div class="left">
                ...
                <!--百度分享-->
                <script src='/jiehun/goto/my-65542.js' language='javascript'/>
