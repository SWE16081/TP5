<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:79:"G:\phpStudy\PHPTutorial\WWW\TP5\public/../application/admin\view\cate\edit.html";i:1538575444;s:70:"G:\phpStudy\PHPTutorial\WWW\TP5\application\admin\view\common\top.html";i:1535440660;s:71:"G:\phpStudy\PHPTutorial\WWW\TP5\application\admin\view\common\left.html";i:1535542199;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title></title>
            ...
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        ...
                        <input type="hidden" name="cateid" value="<?php echo $cates['cateid']; ?>">
                        <div class="form-group">
                            <label for="catename" class="col-sm-2 control-label no-padding-right">栏目名称</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="catename" placeholder="" value="<?php echo $cates['catename']; ?>"name="catename"  type="text">
                            </div>
