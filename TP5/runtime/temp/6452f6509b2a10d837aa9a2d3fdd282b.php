<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"/phpstudy/www/TP5/public/../application/admin/view/article/edit.html";i:1538992498;s:56:"/phpstudy/www/TP5/application/admin/view/common/top.html";i:1538992498;s:57:"/phpstudy/www/TP5/application/admin/view/common/left.html";i:1538992498;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title></title>
    ...
    <!--Basic Styles-->
    <link href="http://123.207.89.57/TP5/public/static/admin/style/bootstrap.css" rel="stylesheet">
    <link href="http://123.207.89.57/TP5/public/static/admin/style/font-awesome.css" rel="stylesheet">
    <link href="http://123.207.89.57/TP5/public/static/admin/style/weather-icons.css" rel="stylesheet">

    <!--Beyond styles-->
    <link id="beyond-link" href="http://123.207.89.57/TP5/public/static/admin/style/beyond.css" rel="stylesheet" type="text/css">
    <link href="http://123.207.89.57/TP5/public/static/admin/style/demo.css" rel="stylesheet">
    <link href="http://123.207.89.57/TP5/public/static/admin/style/typicons.css" rel="stylesheet">
    <link href="http://123.207.89.57/TP5/public/static/admin/style/animate.css" rel="stylesheet">

    <script type="text/javascript" src="http://123.207.89.57/TP5/public/static/admin/ueditor/ueditor.config.js"></script>
    <script type="text/javascript" src="http://123.207.89.57/TP5/public/static/admin/ueditor/ueditor.all.min.js"></script>
    <script type="text/javascript" src="http://123.207.89.57/TP5/public/static/admin/ueditor/lang/zh-cn/zh-cn.js"></script>
        ...
        <div class="navbar-container">
            ...
            <div class="navbar-header pull-left">
                <a href="#" class="navbar-brand">
                    <small>
                        <img src="http://123.207.89.57/TP5/public/static/admin/images/logo.png" alt="">
                    </small>
                </a>
            </div>
            <!-- /Navbar Barnd -->
                        ...
                        <li>
                            <a class="login-area dropdown-toggle" data-toggle="dropdown">
                                <div class="avatar" title="View your public profile">
                                    <img src="http://123.207.89.57/TP5/public/static/admin/images/adam-jansen.jpg">
                                </div>
                                <section>
...
<div class="row">
    <div class="col-lg-12 col-sm-12 col-xs-12">
                    ...
                    <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <?php if($article['pic'] != ''): ?>
                                <img src="http://123.207.89.57/TP5/public/static<?php echo $article['pic']; ?>" height="50" width="40">
                                <?php else: ?>
                                暂无缩略图
                                <?php endif; ?>
                            </div>
	    ...
	    <!--Basic Scripts-->
    <script src="http://123.207.89.57/TP5/public/static/admin/style/jquery_002.js"></script>
    <script src="http://123.207.89.57/TP5/public/static/admin/style/bootstrap.js"></script>
    <script src="http://123.207.89.57/TP5/public/static/admin/style/jquery.js"></script>
    <!--Beyond Scripts-->
    <script src="http://123.207.89.57/TP5/public/static/admin/style/beyond.js"></script>
