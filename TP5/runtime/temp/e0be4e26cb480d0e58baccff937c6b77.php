<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:79:"G:\phpStudy\PHPTutorial\WWW\TP5\public/../application/admin\view\links\lst.html";i:1538575445;s:70:"G:\phpStudy\PHPTutorial\WWW\TP5\application\admin\view\common\top.html";i:1535440660;s:71:"G:\phpStudy\PHPTutorial\WWW\TP5\application\admin\view\common\left.html";i:1535542199;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title></title>
...
<button type="button" tooltip="添加链接" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('links/add'); ?>'"><!--错误无影响-->
                ...
                <div class="flip-scroll">
                    <table class="table table-bordered table-hover">
                        ...
                        <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$user): $mod = ($i % 2 );++$i;?>
                               ...
                               <td align="center"><a href="<?php echo $user['url']; ?>" target="_blank"><?php echo $user['url']; ?></a></td>
                               <td align="center">
                                   <?php if($user['desc'] != ''): ?>
                                   <?php echo $user['desc']; else: ?>暂无描述
                                   <?php endif; ?>
                               </td>
                                <td align="center">
                                    <a href="<?php echo url('links/edit',array('id'=>$user['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <a href="#" onClick="warning('确实要删除吗', '<?php echo url('links/del',array('id'=>$user['id'])); ?>')" class="btn btn-danger btn-sm shiny">
